...
create table tb_score (value float8, movie_id int8 not null, user_id int8 not null, movie_id_id int8 not null, movies_id_id int8, primary key (movie_id, user_id));
...
alter table if exists tb_score add constraint FKqsnusfdbjuyj95fpj9pi0qnpt foreign key (movie_id_id) references tb_movie;
alter table if exists tb_score add constraint FKh96ooy889bmxsgiixs7ecx509 foreign key (movies_id_id) references tb_movie;
